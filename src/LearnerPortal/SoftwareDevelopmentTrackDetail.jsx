...
const SoftwareDevelopmentTrackDetail = () => {
  // Since this is a specific component for Software Development, we can define the course data directly
  const course = {
    id: 1,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="text-blue-100 mb-6 leading-relaxed">
                ...
                <p>Become a Full-Stack Web Developer with a single comprehensive course covering HTML, CSS, JavaScript, Node, React, PostgreSQL, Web3, and DApps!</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-lg border overflow-hidden">
            ...
            <div className="p-4">
              ...
              <div className="text-center">
                ...
                {/* FIXED: Added inline-block and text-center classes */}
                <Link 
...
export default SoftwareDevelopmentTrackDetail;