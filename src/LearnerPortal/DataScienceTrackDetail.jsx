...
const DataScienceTrackDetail = () => {
  // Data Science specific course data
  const course = {
    id: 2,
    title: "Data Science Mastery",
    description:
      "Equip yourself with the skills to analyze, interpret, and leverage data. Master Python, R, SQL, Machine Learning, and advanced analytics to become a data science expert!",
    ...
    image: DataScience,
    learn: [
      "Master Python and R programming for data analysis and statistical computing.",
      "Learn advanced SQL queries and database management for big data.",
      "Build machine learning models using scikit-learn, TensorFlow, and PyTorch.",
      "Create stunning data visualizations with Matplotlib, Seaborn, and Tableau.",
      "Work with real-world datasets and complete industry-relevant projects.",
      ...
      <div className="bg-[#01589A] text-white relative">
        ...
        <div className="max-w-7xl mx-auto px-4 pt-4">
          <div className="flex items-center space-x-2 text-sm text-blue-100">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-white">Data Science Mastery</span>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="text-blue-100 mb-6 leading-relaxed">
                <p>Equip yourself with the skills to analyze, interpret, and leverage data.</p>
                <p>Master Python, R, SQL, Machine Learning, and advanced analytics to become a data science expert!</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-lg border overflow-hidden">
            ...
            <div className="p-4">
              ...
              <div className="text-center">
                ...
                {/* FIXED: Added proper styling to make Link display as button */}
                <Link
...
export default DataScienceTrackDetail;